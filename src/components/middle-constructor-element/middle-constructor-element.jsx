...
export const MiddleConstructorElement = ({ element, index, moveIngredient }) => {
  ...
  return (
    <li className={`${constructorStyles.transposableElement} mt-4`} ref={ref} style={{ opacity }} data-handler-id={handlerId}>
